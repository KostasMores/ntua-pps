...
__device__ int get_tid(){
	...
	return tid; /* TODO: Calculate 1-Dim global ID of a thread */
}
						...
						int blockSize)
{
	...
	fprintf(fp, "%s,%d,%lf,%lf,%lf,%lf,%lf,%lf\n", "Naive", blockSize, timing/loop, timer_min, timer_max, gpu_time*1000, cpu_time*1000, transfer_time*1000);
	fclose(fp); 
